...
| Param  | Description                       |
| ------ | --------------------------------- |
| `sObj` | An instance of sObject to create. |

#### Returns

| Type      | Description                                                 |
| --------- | ----------------------------------------------------------- |
| `SObject` | `SObject` object that's had it's required fields populated. |
...
| `doInsert` | Boolean should this object be inserted? If false, then a fake id will be assigned. |
